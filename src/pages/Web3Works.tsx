...
const projects = [
  ...
  {
    title: "Token Staking Dashboard",
    category: "Frontend Web3",
    image: "https://picsum.photos/seed/staking/800/600",
    link: "#"
  },
  {
    title: "Decentralized Exchange",
    category: "Smart Contracts",
    image: "https://picsum.photos/seed/dex/800/600",
    link: "#"
  }
];
          ...
          <div>
            ...
            <FadeIn delay={0.2}>
              <p className="text-xl md:text-2xl text-sec/70 max-w-3xl font-medium">
                Discover my latest decentralized applications, smart contracts, and Web3 integrations.
              </p>
            </FadeIn>
          </div>
